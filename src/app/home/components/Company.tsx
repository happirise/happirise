...
export default function Company() {
  return (
    <Container id="company" title="会社情報" mt="-mt-16">
      <div className="grid lg:grid-cols-12 lg:gap-5 gap-7 lg:mb-12 mb-8">
        ...
        <div className="lg:col-span-7 text-sm leading-7">
          ...
          <div className="text-right lg:p-0 pt-4">
            代表取締役社長 安藤 龍之介
          </div>
        </div>
      </div>
      <div className="grid grid-cols-2 text-sm leading-7">
        {CompanyInfo.map((info) => (
          ...
          >
            <h3 className="w-24 mr-4 border-b-[1px] border-black">
              {info.title}
            </h3>
            <p className="w-full lg:mr-4 border-b-[1px] border-gray-300">
              {info.value}
            </p>
          </div>
        ))}
